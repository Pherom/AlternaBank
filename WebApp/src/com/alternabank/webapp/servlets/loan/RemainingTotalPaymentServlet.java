...
@WebServlet(name = "RemainingTotalPaymentServlet", urlPatterns = "/pay-remaining")
public class RemainingTotalPaymentServlet extends HttpServlet {
                    ...
                    synchronized (getServletContext()) {
                        ...
                        if (loan != null) {
                            if(loan.getOriginalRequest().getBorrowerName().equals(username)) {
                                loan.executeRemainingTotalPayment();
